...
import styles from './CarouselExpert.module.scss';
...
function CarouselExpert() {
  const [_items, _setItems] = useState([]);
  const [items, setItems] = useState([]);
  useEffect(() => {
    fetch(FRONT_PORT + '/data/hwseol/expert_carousel.json', {
      method: 'GET',
    })
      .then(res => res.json())
      .then(data => {
